...
alter table public.brain_game_results
  ...
  check (category in ('memory', 'attention', 'speed', 'logic', 'math'));

alter table public.brain_game_progress
  drop constraint brain_game_progress_category_check;
alter table public.brain_game_progress
  add constraint brain_game_progress_category_check
  check (category in ('memory', 'attention', 'speed', 'logic', 'math'));
