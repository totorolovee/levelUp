...
export const stocks: Stock[] = [
  ...
  { symbol: 'HSBK', quoteSymbol: 'HSBK.L', displayWithoutQuote: true, exchange: 'London Stock Exchange', name: 'Halyk Bank', price: 0, change: 0, sector: 'Банки', business: 'Предоставляет банковские, платёжные и инвестиционные услуги в Казахстане.', strength: 'Крупная клиентская база и сильная позиция на рынке Казахстана.', risk: 'Зависимость от экономики, ставок и регулирования финансового сектора.', competitors: 'Kaspi.kz, Freedom Bank, ForteBank' },
];
