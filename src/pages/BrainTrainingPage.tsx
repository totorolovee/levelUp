...
export function BrainTrainingPage() {
  ...
  return (
    <main className="shell brain-training-page">
      ...
      {stage === 'result' && <BrainGameResultScreen dailyPosition={isDailyTraining ? { current: dailyIndex + 1, total: plan.length } : undefined} isRussian={isRussian} onContinue={continueAfterResult} perfectRequired={gameId === 'face-name'} result={result} timedChallenge={gameId === 'coffee'} />}
