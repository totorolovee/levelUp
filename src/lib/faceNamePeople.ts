...
export const faceNameNames: Record<PersonGender, LocalizedText[]> = {
  female: [
    { ru: 'Майя', en: 'Maya' }, { ru: 'София', en: 'Sofia' },
    { ru: 'Амина', en: 'Amina' }, { ru: 'Зои', en: 'Zoe' },
    { ru: 'Эмма', en: 'Emma' }, { ru: 'Нина', en: 'Nina' },
    { ru: 'Ева', en: 'Eva' }, { ru: 'Лина', en: 'Lina' },
    { ru: 'Мила', en: 'Mila' }, { ru: 'Нора', en: 'Nora' },
    { ru: 'Лейла', en: 'Layla' }, { ru: 'Анна', en: 'Anna' },
  ],
  male: [
    { ru: 'Алекс', en: 'Alex' }, { ru: 'Дэниел', en: 'Daniel' },
    { ru: 'Лео', en: 'Leo' }, { ru: 'Ноа', en: 'Noah' },
    { ru: 'Лукас', en: 'Lucas' }, { ru: 'Омар', en: 'Omar' },
    { ru: 'Макс', en: 'Max' }, { ru: 'Адам', en: 'Adam' },
    { ru: 'Бен', en: 'Ben' }, { ru: 'Амир', en: 'Amir' },
    { ru: 'Виктор', en: 'Victor' }, { ru: 'Марк', en: 'Mark' },
  ],
};

export const faceNameProfiles: FaceNameProfile[] = [
  {
    sprite: 'base', gender: 'male', column: 0, row: 0,
  ...
  {
    sprite: 'base', gender: 'female', column: 1, row: 0,
  ...
  {
    sprite: 'base', gender: 'male', column: 2, row: 0,
  ...
  {
    sprite: 'base', gender: 'female', column: 3, row: 0,
  ...
  {
    sprite: 'base', gender: 'male', column: 0, row: 1,
  ...
  {
    sprite: 'base', gender: 'female', column: 1, row: 1,
  ...
  {
    sprite: 'base', gender: 'male', column: 2, row: 1,
  ...
  {
    sprite: 'base', gender: 'female', column: 3, row: 1,
  ...
  {
    sprite: 'extra', gender: 'female', column: 0, row: 0,
  ...
  {
    sprite: 'extra', gender: 'male', column: 1, row: 0,
  ...
  {
    sprite: 'extra', gender: 'female', column: 2, row: 0,
  ...
  {
    sprite: 'extra', gender: 'male', column: 0, row: 1,
  ...
  {
    sprite: 'extra', gender: 'female', column: 1, row: 1,
